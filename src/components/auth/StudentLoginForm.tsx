        ...
        <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden font-sans">
            ...
            <header className="flex items-center justify-between px-8 py-6 md:px-12 relative z-50">
                <Link href="/" className="flex items-center gap-4 group">
                    ...
                    <div>
                        ...
                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1.5">{headerData?.logoText || "NGI Study Zone Education"}</p>
                    </div>
                </Link>
                ...
                <div className="w-full max-w-[450px]">
                    ...
                    <div className="bg-white border border-slate-100 rounded-[2.5rem] p-10 md:p-12 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
                        ...
                        <div className="text-center">
                            <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mb-4">New to NGI Study Zone?</p>
                            <Link href="/register">
            ...
            <footer className="px-12 py-8 flex justify-center items-center relative z-50">
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">
                    NGI Study Zone Academy • 2025 • Educational Portal
                </p>
            </footer>
        </div>
