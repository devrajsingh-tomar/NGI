    ...
    return (
        <div
            ...
            className={cn(
                ...
                isSelected 
                    ? "border-amber-400 shadow-xl shadow-orange-100 ring-2 ring-amber-500/5 rotate-1" 
        ...
        >
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                        <span className="text-[9px] font-black text-amber-600 bg-orange-50 px-2 py-0.5 rounded-full uppercase tracking-widest">
                ...
                <div className="flex items-center gap-1.5 ml-auto" onClick={(e) => e.stopPropagation()}>
                    <button
                        ...
                        className={cn(
                            ...
                            section.is_active ? "text-amber-600 hover:bg-orange-50" : "text-slate-400 hover:bg-slate-100"
                        )}
                    ...
                    <Link 
                        ...
                        className="p-2 rounded-xl text-slate-400 hover:text-amber-600 hover:bg-orange-50 transition-all"
                        title="Edit Content"
                    >
            ...
            {isSelected && (
                <div className="absolute -top-2 -right-2 w-6 h-6 bg-amber-600 rounded-full flex items-center justify-center shadow-lg border-2 border-white animate-in zoom-in duration-300">
