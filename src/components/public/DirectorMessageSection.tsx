                        ...
                        <div className="relative w-full aspect-square max-w-[500px] mx-auto group">
                            ...
                            <div className="relative w-full h-full overflow-hidden rounded-[3.5rem] border-8 border-white/10 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.8)] z-10">
                                {director.image ? (
                                    ...
                                    <div className="w-full h-full bg-orange-900 flex items-center justify-center text-white/10 text-6xl font-black italic">
                                        NGI Study Zone
                                    </div>
                                )}
                        ...
                        <div className="relative group max-w-xl">
                            ...
                            <div className="relative pt-6">
                                ...
                                <div className="mt-12 flex items-center gap-6">
                                    ...
                                    <p className="text-[11px] font-black uppercase tracking-[0.5em] text-white/60">Chairman's Commitment</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
