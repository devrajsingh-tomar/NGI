...
export default function HeroSlider() {
    ...
    if (loading) {
        return (
            <div className="relative w-full h-[85vh] md:h-[90vh] bg-gradient-to-br from-primary via-primary to-orange-900 flex items-center justify-center">
            ...
            {slides.map((slide, index) => (
                ...
                >
                    ...
                    {slide.imageUrl ? (
                        ...
                        <div className={cn("absolute inset-0 bg-gradient-to-br", slide.bgColor || "from-primary via-primary to-orange-900")}>
