    ...
    return (
        <div className="container mx-auto px-4 lg:px-10 py-16">
            <div className="bg-slate-900 rounded-[3rem] p-10 md:p-16 lg:p-20 relative overflow-hidden shadow-2xl border border-slate-800">
                ...
                <div className="absolute top-0 right-0 w-96 h-96 bg-amber-500/20 rounded-full blur-[100px] -mr-48 -mt-48" />
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-amber-500/20 rounded-full blur-[100px] -ml-48 -mb-48" />
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    <div className="flex-1 space-y-8 text-center lg:text-left">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight">
                            Master Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-400 italic">Typing Speed</span>
                        </h2>
                        ...
                        <div className="bg-slate-800/50 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-[2.5rem] shadow-2xl rotate-y-[-10deg] rotate-x-[5deg] hover:rotate-0 transition-transform duration-700">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex gap-2 pt-2">
                                    <div className="h-4 bg-amber-500/50 rounded-full w-[40%]" />
                                    <div className="h-4 bg-transparent border border-amber-500/30 rounded-full w-[2px] animate-pulse" />
                                </div>
                            </div>
                        </div>
                    </div>
