...
export default function NoticeSliderSection({ notices = [] }: { notices?: Notice[] }) {
    ...
    return (
        <section className="py-24 bg-white relative overflow-hidden">
            <div className="container px-6 mx-auto relative z-10">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 px-4">
                    <div className="space-y-4">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 border border-orange-100/50">
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            >
                                ...
                                <div className="shrink-0 w-24 h-24 md:w-32 md:h-32 bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center justify-center p-4">
                                    <Calendar className="w-6 h-6 text-primary mb-2 opacity-20" />
                        ...
                        {activeNotices.map((_, i) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    index === i ? "w-8 bg-primary" : "w-2 bg-slate-200 hover:bg-slate-300"
                                )}
                            />
                        ))}
                    </div>
            ...
            {/* Decorations */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-amber-400/5 rounded-full blur-[120px] -z-10" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-amber-500/5 rounded-full blur-[100px] -z-10" />
        </section>
    );
}
