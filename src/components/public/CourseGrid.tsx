        ...
        <div className="container mx-auto px-4 lg:px-10 py-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {blocks.map((block: any, idx: number) => {
                    ...
                    return (
                        <div key={block._id || idx} className={`p-8 rounded-[2rem] bg-white border ${extra.borderColor || "border-orange-100"} shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300`}>
                            {block.image && (
                            ...
                            <div className="flex justify-between items-center mb-4">
                                <span className="text-sm font-bold text-primary bg-orange-50 px-3 py-1 rounded-full">{block.subtitle || "Course"}</span>
