                ...
                <Table>
                    <TableHeader className="bg-slate-50 border-b border-slate-200">
                        <TableRow className="hover:bg-transparent border-none">
                            <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest py-6 pl-10">Candidate</TableHead>
                            <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest py-6">Assessment / Course</TableHead>
                            <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest py-6 text-center">Batch</TableHead>
                            <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest py-6 text-center">Score Portfolio</TableHead>
                            <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest py-6 text-center">A.I. Rank</TableHead>
                            <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest py-6">Release Status</TableHead>
                            <TableHead className="font-bold text-slate-500 text-[10px] uppercase tracking-widest py-6 text-right pr-10">Control</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {loading ? (
