    ...
    <div className="flex flex-col h-full bg-[#f5f7fb]">
      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={openNew}
            className="flex items-center gap-1.5 px-4 py-2 bg-amber-600 hover:bg-orange-600 text-white text-xs font-bold rounded-lg transition-all shadow-sm"
          >
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <button onClick={openNew} className="flex items-center gap-2 px-5 py-2.5 bg-amber-600 text-white font-bold rounded-xl hover:bg-orange-600 transition-all">
              ...
              >
                ...
                <div className="p-4 flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                    ...
                    >
                      {slide.isActive ? <Eye className="w-4 h-4 text-amber-500" /> : <EyeOff className="w-4 h-4" />}
                    </button>
                    <button
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden">
                  ...
                  {BG_PRESETS.map((preset) => (
                    <button
                      ...
                      className={cn(
                        ...
                        preset.value,
                        form.bgColor === preset.value ? "border-amber-500 scale-105 shadow-lg" : "border-transparent opacity-80 hover:opacity-100"
                      )}
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-amber-400 font-medium"
                    />
                    <button 
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. Shape Your Future at NGI Study Zone"
                    className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-amber-400 focus:ring-2 focus:ring-violet-100 font-medium"
                  />
                  <div className="mt-4 p-5 bg-orange-50 border border-orange-100 rounded-2xl space-y-3">
                    <div className="flex items-center gap-2 text-orange-600 font-black text-[11px] uppercase tracking-widest">
                    ...
                    <div className="pt-2 border-t border-orange-100 flex items-center gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-amber-400 focus:ring-2 focus:ring-violet-100 font-medium resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <input value={form.cta1Text} onChange={(e) => setForm(f => ({ ...f, cta1Text: e.target.value }))} placeholder="Download Prospectus" className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-amber-400 font-medium" />
                </div>
                <div>
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-1.5">Button 1 Link</label>
                  <input value={form.cta1Link} onChange={(e) => setForm(f => ({ ...f, cta1Link: e.target.value }))} placeholder="/prospectus.pdf" className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-amber-400 font-medium" />
                </div>

                {/* CTA 2 */}
                <div>
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-1.5">Button 2 Text</label>
                  <input value={form.cta2Text} onChange={(e) => setForm(f => ({ ...f, cta2Text: e.target.value }))} placeholder="Book Free Demo" className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-amber-400 font-medium" />
                </div>
                <div>
                  <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest block mb-1.5">Button 2 Link</label>
                  <input value={form.cta2Link} onChange={(e) => setForm(f => ({ ...f, cta2Link: e.target.value }))} placeholder="/register" className="w-full px-3 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-lg outline-none focus:border-amber-400 font-medium" />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    form.isActive ? "bg-amber-600" : "bg-slate-300"
                  )}
                >
                  <span className={cn(
            ...
            <div className="p-5 border-t border-slate-100 flex justify-end gap-3 shrink-0">
              ...
              <button
                onClick={handleSave}
                disabled={submitting}
                className="flex items-center gap-2 px-5 py-2 bg-amber-600 hover:bg-orange-600 text-white text-sm font-bold rounded-lg transition-all shadow-sm disabled:opacity-60"
              >
