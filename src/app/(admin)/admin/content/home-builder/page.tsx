            ...
            <div className="bg-white border-b border-slate-200 px-8 py-5 flex items-center justify-between shrink-0 shadow-sm z-10">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 bg-amber-600 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-orange-600 transition-all shadow-xl shadow-orange-200"
                    >
                ...
                <div className="w-full max-w-xl p-8 overflow-y-auto space-y-6">
                    ...
                    {loading ? (
                        ...
                        <div className="py-24 text-center bg-white border-4 border-dashed border-slate-100 rounded-[3rem]">
                            ...
                            <button onClick={() => setShowAddPanel(true)} className="px-6 py-3 bg-amber-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:scale-105 transition-all">
                                Inject First Module
                            </button>
                        </div>
                    ) : (
                    ...
                    {selectedSection ? (
                        <div className="max-w-md animate-in slide-in-from-right-4 duration-500">
                            <div className="flex items-center gap-5 mb-10 pb-8 border-b border-slate-100">
                                <div className="w-16 h-16 rounded-[2rem] bg-amber-600 text-white flex items-center justify-center shadow-2xl shadow-orange-200 rotate-3">
                            ...
                            <div className="space-y-8">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-4 text-sm font-black bg-slate-50 border border-slate-100 rounded-2xl outline-none focus:border-amber-400 focus:ring-4 focus:ring-amber-500/5 transition-all"
                                    />
                                </div>
                                ...
                                <div className="p-8 bg-amber-600 rounded-[2.5rem] text-white shadow-2xl shadow-orange-200 relative overflow-hidden group">
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-xs text-orange-100 font-medium leading-relaxed opacity-90 mb-6">
                                            {selectedSection.section_type === "HeroSection" 
                                        ...
                                        <Link href={selectedSection.section_type === "HeroSection" ? "/admin/content/home-builder/slider" : "/admin/content/pages"}>
                                            <button className="w-full py-4 bg-white text-amber-600 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-orange-50 transition-all shadow-xl active:scale-95">
                            ...
                            {SECTION_TYPES.map((st) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className="flex flex-col items-start p-6 border-2 border-slate-50 rounded-[2rem] hover:border-orange-200 hover:bg-orange-50/30 transition-all text-left group"
                                    >
                                        <div className="w-12 h-12 rounded-2xl bg-orange-100 text-amber-600 flex items-center justify-center mb-5 group-hover:scale-110 group-hover:rotate-6 transition-all shadow-inner">
