    ...
    <div className="flex flex-col h-full bg-[#f5f7fb]">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { label: "Total Leads", value: leads.length, color: "bg-orange-50 text-amber-600", icon: MessageSquare },
            ...
            { label: "Callback Requests", value: leads.filter(l => l.formType === "Callback").length, color: "bg-orange-50 text-amber-600", icon: Phone },
          ].map((stat) => (
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-8 pr-4 py-2 w-full text-xs font-medium bg-white border border-slate-200 rounded-lg outline-none focus:border-amber-400"
            />
          </div>
            ...
            {["all", "new", "resolved"].map((f) => (
              <button
                ...
                className={cn(
                  ...
                  filter === f ? "bg-amber-600 text-white" : "bg-white border border-slate-200 text-slate-600 hover:bg-slate-50"
                )}
              >
                {f}
              </button>
