        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 py-12 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-500 mt-2 text-base">Fill in your details to create your NGI Study Zone student account</p>
                </div>
                ...
                <p className="text-center text-xs text-slate-400 mt-6">
                    By registering, you agree to NGI Study Zone's Terms of Service and Privacy Policy.
                </p>
            </div>
        </div>
    );
