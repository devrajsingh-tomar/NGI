    ...
    return (
        <div className="max-w-4xl mx-auto py-16 px-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            <div className="w-full md:w-1/3 shrink-0">
                                <div className="aspect-[4/3] bg-slate-900 rounded-[2.5rem] overflow-hidden relative shadow-2xl flex items-center justify-center p-6 text-center border-4 border-slate-800">
                                    ...
                                    <div className="relative z-10">
                                        <div className="text-amber-400 font-black text-2xl mb-1 italic">NGI Study Zone</div>
            ...
            <div className="mt-20 text-center space-y-4">
                ...
                <h4 className="font-black text-slate-900 uppercase tracking-[0.3em] text-xs">NGI Study Zone Institute Credentialing Administration</h4>
                ...
                <div className="pt-6">
                     <p className="text-[9px] text-slate-300 font-medium">© {new Date().getFullYear()} NGI Study Zone Institute. All achievements securely archived.</p>
                </div>
            </div>
        </div>
    );
