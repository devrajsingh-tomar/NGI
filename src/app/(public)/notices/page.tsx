...
export const metadata = {
    title: "Official Announcements & Notices | NGI Study Zone",
    description: "Stay updated with the latest announcements, schedules, and official notices from NGI Study Zone Institute."
};
            ...
            <div className="container px-6 mx-auto relative z-10 max-w-5xl">
                ...
                <div className="text-center md:text-left mb-10 md:mb-16 max-w-3xl space-y-6">
                    ...
                    <p className="text-base md:text-lg text-slate-500 font-medium leading-relaxed">
                        Stay informed with the latest organizational directives, exam schedules, and institutional events posted by the NGI Study Zone administrative board.
                    </p>
                </div>
