    ...
    <div className="min-h-screen bg-slate-50 pt-32 pb-24">
        <div className="container mx-auto px-4 lg:px-10">
            <div className="text-center max-w-4xl mx-auto mb-16 space-y-6">
                <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-orange-100 text-orange-700 font-bold uppercase tracking-widest text-sm border border-orange-200">
                    <Camera className="w-5 h-5" /> NGI Study Zone Life
                </div>
