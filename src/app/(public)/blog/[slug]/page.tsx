...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
    ...
    if (!res.success) return { title: "Post Not Found | NGI Study Zone" };
    const post = res.data;
    
    return {
        title: `${post.metaTitle || post.title} | NGI Study Zone Official Blog`,
        description: post.metaDescription || post.excerpt || `Read ${post.title} on NGI Study Zone Official Blog`,
        ...
        openGraph: {
            ...
            authors: [post.author?.name || "NGI Study Zone admin"],
        }
    };
}
